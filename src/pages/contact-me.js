...
const SecondPage = () => (
  <Layout>
    ...
    <p>
      Oh ya, I'm actively <a href="http://twitter.com/pradityabgs">tweeting</a>. And (maybe) will be writing something on <a href="https://medium.com/@pradityabagus">my medium</a>. As part of the awesome developer community, I also have a <a href="https://github.com/pradityabagus">Github account</a>. Mainly I star awesome repositories. This webpage is hosted on there too.
    </p>
